 ...
 *
 * DESCRIPTION: This function inserts they (key,value) pair into the local hash
 * table
 *
 * RETURNS:
 * true on SUCCESS
 ...
 *
 * DESCRIPTION: This function updates the given key with the updated value
 * passed in if the key is found
 *
 * RETURNS:
 * true on SUCCESS
 * false on FAILURE
 ...
 *
 * DESCRIPTION: This function deletes the given key and the corresponding value
 * if the key is found
 *
 * RETURNS:
 * true on SUCCESS
 ...
 * false otherwise
 */
bool HashTable::isEmpty() { return hashTable.empty(); }
 ...
 */
void HashTable::clear() { hashTable.clear(); }
